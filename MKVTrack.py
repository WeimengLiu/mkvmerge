...
from Verification import verify_supported
...
class MKVTrack:
    ...
    def __init__(self, file_path, track_id=0, track_name=None, language=None, default_track=False, forced_track=False):
        ...
        # base
        self.mkvmerge_path = get_mkvmerge_path()
    ...
    def track_id(self, track_id):
        ...
        info_json = json.loads(sp.check_output([self.mkvmerge_path, '-J', self.file_path],
                                               startupinfo=startupinfo,
                                               creationflags=sp.CREATE_NO_WINDOW).decode())
